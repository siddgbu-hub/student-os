        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g., GDPR Right-to-be-forgotten request, account reset purge..."
              maxLength={500}
              rows={2}
              className="w-full px-3 py-2 text-xs bg-slate-950 border border-slate-800 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-red-500 transition-colors resize-none"
            />
          </div>
          ...
          <div className="pt-1">
            <label className="block text-xs font-bold text-red-400 mb-1.5">
              Type <span className="font-mono underline font-extrabold text-white">DELETE</span> to confirm permanent erasure
            </label>
            <input
              type="text"
              value={confirmText}
