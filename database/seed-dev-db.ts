...
VALUES ('${accountId}', '${email}', '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(0)}');

INSERT INTO devices (device_id, account_id, device_model, os_version, is_active, registered_at, last_active_at)
VALUES ('${deviceId}', '${accountId}', 'MacBook Pro', 'macOS', 1, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(0)}');

-- 2. Create Subjects
INSERT INTO subjects (id, account_id, name, created_at, updated_at) VALUES
('subj-math', '${accountId}', 'Mathematics', '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('subj-phys', '${accountId}', 'Physics', '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('subj-chem', '${accountId}', 'Chemistry', '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('subj-eng', '${accountId}', 'English', '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('subj-cs', '${accountId}', 'Computer Science', '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}');

-- 3. Create Chapters
-- Mathematics
INSERT INTO chapters (id, subject_id, account_id, name, order_index, is_completed, created_at, updated_at) VALUES
('chap-math-1', 'subj-math', '${accountId}', 'Limits', 1, 1, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-math-2', 'subj-math', '${accountId}', 'Differentiation', 2, 1, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-math-3', 'subj-math', '${accountId}', 'Integration', 3, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-math-4', 'subj-math', '${accountId}', 'Matrices', 4, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-math-5', 'subj-math', '${accountId}', 'Probability', 5, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}');

-- Physics
INSERT INTO chapters (id, subject_id, account_id, name, order_index, is_completed, created_at, updated_at) VALUES
('chap-phys-1', 'subj-phys', '${accountId}', 'Motion', 1, 1, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-phys-2', 'subj-phys', '${accountId}', 'Work & Energy', 2, 1, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-phys-3', 'subj-phys', '${accountId}', 'Gravitation', 3, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-phys-4', 'subj-phys', '${accountId}', 'Current Electricity', 4, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}');

-- Chemistry
INSERT INTO chapters (id, subject_id, account_id, name, order_index, is_completed, created_at, updated_at) VALUES
('chap-chem-1', 'subj-chem', '${accountId}', 'Atomic Structure', 1, 1, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-chem-2', 'subj-chem', '${accountId}', 'Chemical Bonding', 2, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-chem-3', 'subj-chem', '${accountId}', 'Organic Chemistry', 3, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}');

-- English
INSERT INTO chapters (id, subject_id, account_id, name, order_index, is_completed, created_at, updated_at) VALUES
('chap-eng-1', 'subj-eng', '${accountId}', 'Grammar', 1, 1, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-eng-2', 'subj-eng', '${accountId}', 'Reading Comprehension', 2, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-eng-3', 'subj-eng', '${accountId}', 'Essay Writing', 3, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}');

-- Computer Science
INSERT INTO chapters (id, subject_id, account_id, name, order_index, is_completed, created_at, updated_at) VALUES
('chap-cs-1', 'subj-cs', '${accountId}', 'Arrays', 1, 1, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-cs-2', 'subj-cs', '${accountId}', 'Linked Lists', 2, 1, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-cs-3', 'subj-cs', '${accountId}', 'Trees', 3, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}'),
('chap-cs-4', 'subj-cs', '${accountId}', 'Graphs', 4, 0, '${getRelativeIsoStr(-7)}', '${getRelativeIsoStr(-7)}');
...
('sess-yest-3', '${accountId}', 'subj-chem', 'chap-chem-2', '${getRelativeIsoStr(-1, 19, 0)}', '${getRelativeIsoStr(-1, 19, 20)}', 1200, 0, 'cancelled', '${getRelativeIsoStr(-1, 19, 20)}', '${getRelativeIsoStr(-1, 19, 20)}');
...
('sess-today-4', '${accountId}', 'subj-math', 'chap-math-4', '${getRelativeIsoStr(0, 16, 0)}', '${getRelativeIsoStr(0, 16, 15)}', 900, 0, 'cancelled', '${getRelativeIsoStr(0, 16, 15)}', '${getRelativeIsoStr(0, 16, 15)}');
